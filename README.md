...
|------|--------|-------|-------------|
| `/dns/lookup` | GET | $0.002 | DNS lookup / nslookup / dig API — resolve all DNS record types (A, AAAA, MX, TXT, NS, CNAME, SOA… |
...
| `/sentiment/analyze` | POST | $0.002 | Sentiment analysis API — emotion & aspect-based sentiment classifier via Claude Haiku: returns… |
